    ...
    <div class="glass-panel rounded-[2rem] p-6 mb-10 shadow-2xl border border-white/10 sticky top-4 z-30">
      <div class="flex flex-col md:flex-row gap-6 items-center">
        <div class="relative flex-1 w-full">
          <i class="fas fa-search absolute left-5 top-1/2 -translate-y-1/2 text-indigo-400"></i>
          <input type="text" id="searchInput" placeholder="Search product database..." 
            class="w-full pl-14 pr-6 py-4 bg-white/5 border border-white/10 rounded-2xl focus:ring-2 focus:ring-indigo-500 text-white placeholder-slate-500 transition-all">
        </div>

        <div class="relative w-full md:w-64">
          <i class="fas fa-filter absolute left-5 top-1/2 -translate-y-1/2 text-fuchsia-400"></i>
          <select id="sortSelect" class="w-full pl-14 pr-6 py-4 bg-slate-900 border border-white/10 rounded-2xl focus:ring-2 focus:ring-indigo-500 text-white appearance-none cursor-pointer">
        ...
        <button onclick="clearFilters()" class="w-full md:w-auto px-8 py-4 bg-white/5 hover:bg-red-500/20 text-slate-300 hover:text-red-400 font-bold rounded-2xl border border-white/10 transition-all flex items-center justify-center space-x-2">
